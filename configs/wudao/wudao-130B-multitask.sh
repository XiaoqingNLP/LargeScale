...
TRAIN_TOKENS=30000000000 # 30B tokens
...
LR_WARMUP_SAMPLES=$((TRAIN_SAMPLES * 20 / 100))  # 20% warmup
...
TRAIN_ARGS="
       ...
       --adaptive-multitask-encoding \
       --adaptive-multitask-encoding-length 5 \
       --fp16 \
    "
#       --lr-auto-warmup-steps 400 200 \
