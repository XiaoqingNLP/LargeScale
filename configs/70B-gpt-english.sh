...
DATA_PATH="gpt-oscar_text_document"
VOCAB_FILE="/thudm/data/gpt2-vocab.json"
MERGE_FILE="/thudm/data/gpt2-merges.txt"
CHECKPOINT_PATH="/thudm/checkpoints/debug"

NAME="gpt-70B-0.1-shrink-3%-warmup-en"-${TIMESTAMP}
