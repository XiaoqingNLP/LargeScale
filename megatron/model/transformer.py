...
from .positional_embeddings import RotaryEmbedding, apply_rotary_pos_emb_torch, apply_rotary_pos_emb, \
    apply_rotary_pos_emb_index_2d_fused_torch, apply_rotary_pos_emb_index_2d_fused
    ...
    def forward(self, hidden_states, attention_mask, layer_past=None,
        ...
        if self.position_embedding_type == PositionEmbeddingType.rotary:
            if position_ids is not None:
                apply_rotary_fn = apply_rotary_pos_emb_index_2d_fused_torch if self.bf16 \
                    else apply_rotary_pos_emb_index_2d_fused
                # [b, 2, sq] -> [sq, 2, b]
